...
namespace QuanLyBanHang.BLL
{
    class BLL_hanghoa
    {
        ...
        public BLL_hanghoa(GUI.frm_HDNhap f)
        {
            frm_hdn = f;
        }
        public void themhh()
        {
            int ketqua = dAL_hh.Themhang(frm_hh.txt_mahang.Text, frm_hh.txt_tenhang.Text, frm_hh.cb_ncc.SelectedValue.ToString(), frm_hh.txt_soluong.Text,  frm_hh.txt_dongianhap.Text, frm_hh.txt_dongiaban.Text);
            if (ketqua >= 1)
        ...
        public void suahh()
        {
            int ketqua = dAL_hh.Suahang(frm_hh.txt_mahang.Text, frm_hh.txt_tenhang.Text, frm_hh.cb_ncc.SelectedValue.ToString(), frm_hh.txt_soluong.Text, frm_hh.txt_dongianhap.Text, frm_hh.txt_dongiaban.Text);
        ...
        public void LayDSHH_NH()
        {
            frm_hdn.cb_mahang.DataSource = dAL_hh.Loadhh();
            frm_hdn.cb_mahang.DisplayMember = "MaH";
            frm_hdn.cb_mahang.ValueMember = "MaH";
        }
