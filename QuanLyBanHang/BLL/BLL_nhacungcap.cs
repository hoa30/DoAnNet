...
namespace QuanLyBanHang.BLL
{
    class BLL_nhacungcap
    {
        ...
        public BLL_nhacungcap(GUI.frm_HDNhap f)
        {
            frm_hdn = f;
        ...
        public void LayDSNCC_NH()
        {
            frm_hdn.cb_mancc.DataSource = dal_nhacungcap.Loadncc();
            frm_hdn.cb_mancc.DisplayMember = "MaNCC";
            frm_hdn.cb_mancc.ValueMember = "MaNCC";
        }
    }
}
